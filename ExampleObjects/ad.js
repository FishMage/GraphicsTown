...
(function() {
    ...
    Cube.prototype.init = function(drawingState) {
        ...
        if (!buffers) {
            ...
            imageTri.src = "https://c3.staticflickr.com/1/495/31260756570_bbc3f5ef15.jpg" 
    ...
    Cube.prototype.draw = function(drawingState) {
        ...
        modelM = twgl.m4.multiply(twgl.m4.rotationY(Math.PI/5.5+Math.PI),modelM);
...
grobjects.push(new Cube("b1",[-5,1.5,2.8],0.99,[1,1,1]) );