...
(function() {
    ...
    Cube.prototype.init = function(drawingState) {
        ...
        if (!buffers) {
            var arrays = {
                ...
                vnormal : {numComponents:3, data: [
                 ...
                 vTex: {
                  ...
                  vColor:{
                     numComponents: 3,
                    data: [  .99,.76,.0,   .99,.93,.15,   .99,.76,.0,  .99,.93,.15 ]
                  },
            ...
            imageTri.src = "https://c7.staticflickr.com/1/340/31654741646_8a7cd73f5d.jpg" ;
...
grobjects.push(new Cube("b1",[10,1.2,-5],1,[.99,.93,.15]) );