...
(function() {
    ...
    Cube.prototype.init = function(drawingState) {
        ...
        if (!buffers) {
            ...
            imageTri.src = "https://c1.staticflickr.com/1/649/31502410592_4846c19e42.jpg";
    ...
    Cube.prototype.draw = function(drawingState) {
        ...
        var modelM = twgl.m4.scaling([this.size*16,this.size,this.size*7]);
...
grobjects.push(new Cube("b1",[-5,1,-13],0.99,[0,0,0]) );